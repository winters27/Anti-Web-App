...
[assembly: AssemblyDescription("Anti-Web-App")]
...
namespace AntiWebApp {
    class Program {
        ...
        static void Main() {
            ...
            string profileDir = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "AntiWebApp_Profile_b01d21d7");
            // =========================
